...
public partial class RiseFallTimeControl : ComponentBase
{
    ...
    private async void LoadRiseFallTimeAsync()
    {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                using (var streamReader = new StreamReader(deflateStream))
                {
                    ...
                    if (!IsValidJson(responseBody))
                    {
                        ...
                        Dispatcher.UIThread.InvokeAsync(() => RiseFallTime.Text = "加载日出日落时间失败");
                        return;
                    }
                    ...
                    Dispatcher.UIThread.InvokeAsync(() => RiseFallTime.Text = riseFallTime);
                }
            }
        }
        ...
        catch (Exception e)
        {
            ...
            Dispatcher.UIThread.InvokeAsync(() => RiseFallTime.Text = "加载日出日落时间时发生未知错误");
        }
    }
